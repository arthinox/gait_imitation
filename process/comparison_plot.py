...
# ref = pd.read_csv("C:/Users/oddly/Documents/senior_research/custom_environments/DNE_joint_angle_data.csv")
sim_data = pd.read_csv("19_joint_angles.csv")
ref = pd.read_csv("C:/Users/oddly/Documents/senior_research/custom_environments/DNE_joint_angle_data.csv")

la = np.roll(sim_data['l_ankle_angle'].to_numpy(), 165)
lk = np.roll(sim_data['l_knee_angle'].to_numpy(), 165)
lh = np.roll(sim_data['l_hip_angle'].to_numpy(), 165)

ra = np.roll(sim_data['r_ankle_angle'].to_numpy(), 65)
rk = np.roll(sim_data['r_knee_angle'].to_numpy(), 65)
rh = np.roll(sim_data['r_hip_angle'].to_numpy(), 65)
